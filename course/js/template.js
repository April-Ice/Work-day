/*! art-template@4.11.0 for browser | https://github.com/aui/art-template */ ! function (e, t) {
    ...
    return function (e) {
            ...
            use: function (e, t, n, o) {
                ...
                switch ("#" === t && h("#value", "@value"), l) {
                    ...
                    case "/block":
                        ...
                        break;
                    case "echo":
                        l = "print", h("echo value", "value");
                    case "print":
                    case "include":
                    case "extend":
                        if (0 !== c.join("").trim().indexOf("(")) {
                            p = r._split(a), p.shift(), o = l + "(" + p.join(",") + ")";
                            break
                        }
                    default:
                        if (-1 !== c.indexOf("|")) {
            ...
            x = function () {
                ...
                return e.prototype.getTplTokens = function () {
                    ...
                    var t = this,
                        ...
                        p = u.imports,
                        f = this.CONTEXT_MAP;
                    y(f, e) || -1 !== i.indexOf(e) || (y(r, e) ? (n = r[e], y(o, e) && o[e].forEach(function (e) {
                        return t.importContext(e)
                    })) : n = "$escape" === e || "$each" === e || y(p, e) ? a + "." + e : s + "." + e, f[e] = n, c.push({
                        name: e,
                        value: n
                    }))
                    ...
                    var t = this,
                        ...
                        a = r.code;
                    o && (a = !1 === s || o === i.TYPE_RAW ? l + "+=" + r.code : l + "+=$escape(" + r.code + ")");
                    ...
                    }), x && (r.push(l + "=''"), r.push(u + "(" + v + "," + s + "," + m + ")")), r.push("return " + l), r.push("}");
                    var T = r.join("\n");
                    try {
                        var $ = new Function(a, g, "return " + T)(f, e);
                        return $.mappings = d, $.sourcesContent = [o], $
                    } catch (F) {
                        for (var O = 0, j = 0, S = 0, C = void 0; O < n.length;) {
                            var _ = n[O];
                            if (!this.checkExpression(_.code)) {
                                j = _.tplToken.line, S = _.tplToken.start, C = _.code;
                                break
                            }
                            O++
                        }
        ...
        function s(e) {
            ...
            var c = n.split(/\n/),
                u = Math.max(o - 3, 0),
                p = Math.min(c.length, o + 3),
                f = c.slice(u, p).map(function (e, t) {
                    var n = t + u + 1;
                    return (n === o ? " >> " : "    ") + n + "| " + e
                }).join("\n");
        ...
        (function (t) {
            ...
            function o(e) {
                ...
                for (o = n.index, i = 0; o < t.length; o++) {
                    ...
                    i !== o && (r += t.substring(i, o)), i = o + 1, r += s
                }
        ...
        function r(e, t, n, r) {
            var o = new String(e);
            return o.line = t, o.start = n, o.end = r, o
        }
        var o = function (e, t) {
                ...
                for (var t = e.test.ignoreCase ? "ig" : "g", i = e.test.source + "|^$|[\\w\\W]", s = new RegExp(i, t), a = 0; a < o.length; a++)
                    if ("string" === o[a].type) {
                        for (var c = o[a].line, u = o[a].start, p = o[a].end, f = o[a].value.match(s), l = [], h = 0; h < f.length; h++) {
                            ...
                            if ("string" === v) g && "string" === g.type ? (g.value += m, g.end += m.length) : l.push(x);
                            else {
                                d[0] = new r(d[0], c, u, p);
